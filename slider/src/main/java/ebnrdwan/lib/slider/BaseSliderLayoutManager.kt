...
abstract class BaseSliderLayoutManager(
    context: Context?, orientation: Int, reverseLayout: Boolean,
    val shrinkAmount: Float, val shrinkDistance: Float, val defaultScrollSpeed: Float
    ...
    inner class SmoothScroller(context: Context?, private var speed: Float = defaultScrollSpeed) :
        ...
        override fun computeScrollVectorForPosition(targetPosition: Int): PointF? {
            return this@BaseSliderLayoutManager.computeScrollVectorForPosition(targetPosition)
        }
